...
- [command.CommandSender](src/main/CommandSender.java)
...
- Jennifer
  ...
  - isCoordinateValid(), isPathClear() in rule.GameRule
- Future
  - walkthrough.md
  - code structure design
  - board.BoardManager, board.BoardUpdater, command.CommandSender, rule.GameRule, GUI
- Tingzhou
  - Progress report
- Christopher 
  - unittests
