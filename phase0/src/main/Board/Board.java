...
public class Board {
    ...
    public void movePiece(int oldX, int oldY, int newX, int newY){
        addPiece(getPiece(oldX, oldY), newX, newY);
        removePiece(oldX, oldY);
    }

    public void exchangePiece(int oldX, int oldY, int newX, int newY){
        String pieceOld = getPiece(oldX, oldY);
        String pieceNew = getPiece(newX, newY);
        board[oldX][oldY] = pieceNew;
        board[newX][newY] = pieceOld;
    }// for castling.
