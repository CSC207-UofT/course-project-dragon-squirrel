...
**S**: Class rule.GameRule's sole responsibility is to check whether move is valid according to game rules.  
...
**D**: High level classes such as rule.GameRule depend on the methods outlined by Piece/SuperPiece interfaces rather than 
